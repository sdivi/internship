...
.underline {height: 1px; background-color: white; width: 40px; margin: auto;}
.underlineblue {height: 1px; background-color: #333; width: 40px; margin: auto;}
...
[data-drag=&quot;3&quot;] .col-md-6 {padding-left: 0px !important;}
.rightfield {padding-right: 0px !important;}

.form-group {margin-top: 30px !important;}

[data-drag=&quot;6&quot;] .index1 {padding-right: 0px !important; padding-left: 0px !important;}
[data-drag=&quot;7&quot;] .index1 {padding-right: 0px !important; padding-left: 0px !important;}

#textarea {min-height: 150px !important; resize: vertical;}

@media (max-width: 991px) {
[data-drag=&quot;10&quot;] {margin-left: 15px !important;}
[data-drag=&quot;11&quot;] {margin-left: 15px !important;}
.rightfield {margin-top: 30px;}
.leftfield {padding-right: 0px !important;}
}

[data-drag=&quot;38&quot;] .index0 {padding-left: 0px; padding-right: 0px;}
[data-drag=&quot;38&quot;] .index1 {padding-left: 0px; padding-right: 0px;}
#39 {text-align: left !important;}
</style>
    <script src="js/jquery.js"></script>
    <meta name="page-source"
    content="site-id=540ec485192ad8064fd6fae3, page-id=5411529c284aee137c1d412e, master-page-id=540ec647192ad8064fd6fae4" />
    <title></title>
  </head>
  <body>
    <div id="windowDiv" style="">
      ...
      <div id="bodyContainer" style="width:100%">
            ...
            <div class="simblaEL containerHolder" data-drag="MP36" id="MP36">
              <div class="container">
                ...
                style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; padding-top: 40px; padding-bottom: 40px;">
                  ...
                  <div class="sDivider col-md-8 index1" data-colsize="8"></div>
        ...
        <div class="_dynamicContentArea simblaEL" type="dynamicContainer" data-drag="MP12" id="_MPID0">
          <div class="simblaEL containerHolder" data-drag="4" id="4">
            <div class="container" style="width: 100%; background-color: #f7f7f7;">
              <div class="simblaEL containerHolder" data-drag="1" id="1">
                <div class="container"
                style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; margin-top: 50px; margin-bottom: 50px;">

                  <div class="row simblaEL rDivider" data-drag="2" id="2">
                    <div class="sDivider col-md-8 index0" data-colsize="8">
                      <div class="simblaEL htmlEditor" data-drag="3" id="3">
                        <div class="htmlContent">
                          <form class="form-horizontal">
                            <div class="row form-group">
                              <div class="col-md-6 leftfield">
                                <input id="textinput" name="textinput" type="text" placeholder="Name" class="form-control input-md"
                                required="" />
                              </div>
                              <div class="col-md-6 rightfield">
                                <input id="textinput" name="textinput" type="text" placeholder="Phone"
                            ...
                            <div class="form-group">
                              <div class="col-md-12">
                                <button id="ORDER" name="ORDER" class="btn btn-primary blue">SEND</button>
                              </div>
                            </div>
                          </form>
                        </div>
                    ...
                    <div class="sDivider col-md-4 index1" data-colsize="4" style="">
                      <div class="row simblaEL rDivider" data-drag="38" id="38" data-border-type="Bottom"
                      style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(199, 167, 97); border-radius: 0px; position: relative; margin-top: 30px;">

                        <div class="sDivider col-md-2 index0" data-colsize="2">
                          <div class="simblaEL iconElm" data-drag="39" id="39"
                          style="position: relative; padding-right: 0px; padding-left: 6px;"></div>
                        </div>
                        <div class="sDivider col-md-10 index1" data-colsize="10">
                          <div class="simblaEL tc" data-drag="5" id="5" style="position: relative;">
                            <div class="textContainer"
                            style="padding-bottom: 10px; margin-top: 0px; font-family: Montserrat, sans-serif; border-radius: 4px;"
                            data-border-type="All">
                              <div class="simblaEL simblaImg">
                                <font style="font-size: 18px;" color="#C7A761">Offices</font>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row simblaEL rDivider" data-drag="6" id="6"
                      style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; margin: 40px 0px 0px;">
                        ...
                        <div class="sDivider col-md-2 index0" data-colsize="2">
                          <div class="simblaEL iconElm" data-drag="40" id="40"></div>
                        </div>
                        <div class="sDivider col-md-10 index1" data-colsize="10">
                          <div class="simblaEL tc" data-drag="10" id="10">
                            <div class=" textContainer">
                              <font color="#C7A761" style="font-size: 18px;">5th Avenue, New York, USA</font>
                              <div>
                                <font color="#C7A761" style="font-size: 18px;">+1 212 3456789</font>
                              </div>
                              <div>
                                <font color="#C7A761" style="font-size: 18px;">+1 214 5671234</font>
                              </div>
                              <div>
                                <font color="#C7A761" style="font-size: 18px;">info@company.com</font>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row simblaEL rDivider" data-drag="7" id="7"
                      style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; margin-top: 40px;">

                        <div class="sDivider col-md-2 index0" data-colsize="2">
                          <div class="simblaEL iconElm" data-drag="41" id="41"></div>
                        </div>
                        <div class="sDivider col-md-10 index1" data-colsize="10">
                          <div class="simblaEL tc" data-drag="11" id="11">
                            <div class=" textContainer">
                              <font color="#C7A761" style="font-size: 18px;">Monday- Friday: 08am to 9pm</font>
                              <div>
                                <font color="#C7A761" style="font-size: 18px;">Saturday: 09am to 3pm</font>
                              </div>
                              <div>
                                <font color="#C7A761" style="font-size: 18px;">Sunday: Closed</font>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="simblaEL mapElm" data-drag="42" id="42"
          style="height: 450px; border-top-width: 4px; border-top-style: solid; border-top-color: rgb(199, 167, 97); border-radius: 0px;"
          data-border-type="Top">
            <iframe class="map" scrolling="no" frameborder="0" style="border: 0px; width: 100%; height: 100%;"
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAxJ8eSkp2ZBnjHBUEz_xk3Q3SBv9yzXos&amp;q=5th%20avenue%20New%20york&amp;zoom=15&amp;maptype=roadmap">
            </iframe>
          </div>
        </div>
